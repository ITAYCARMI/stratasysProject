...
def test_square_generator():
    ...
    """
    assert object_generator.square_generator(5)
    assert object_generator.square_generator(15)
    assert object_generator.square_generator(-5)
    assert object_generator.square_generator(-15)
...
def test_rectangle_generator():
    ...
    """
    assert object_generator.rectangle_generator(5)
    assert object_generator.rectangle_generator(15)
    assert object_generator.rectangle_generator(-5)
    assert object_generator.rectangle_generator(-15)
...
def test_circle_generator():
    ...
    """
    assert object_generator.circle_generator(5)
    assert object_generator.circle_generator(15)
    assert object_generator.circle_generator(-5)
    assert object_generator.circle_generator(-15)
