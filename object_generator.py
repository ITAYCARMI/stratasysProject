...
def square_generator(limit):
    ...
    example: {'type': 'square', 'x1': 3, 'y1': 3, 'x2': 5, 'y2': 5}
    """
    if limit < 0:
        return "invalid"
...
def rectangle_generator(limit):
    ...
    example: {'type': 'rectangle', 'x1': 3, 'y1': 2, 'x2': 5, 'y2': 5}
    """
    if limit < 0:
        return "invalid"
...
def generate_array(size, limit):
    ...
    example: [{'type': 'square', 'x1': 3, 'y1': 3, 'x2': 5, 'y2': 5},
              {'type': 'rectangle', 'x1': 3, 'y1': 2, 'x2': 5, 'y2': 5},
              {'type': 'circle', 'x': 3, 'y': 3, 'radius': 2}]
    """
