...
def test_type_intersection():
    ...
    """
    assert utils.type_intersection(s2, s3) is "invalid"
    assert utils.type_intersection(s2, s5) is "invalid"
    assert utils.type_intersection(r1, r2) is "invalid"
    assert utils.type_intersection(s1, r1) is "intersect"
    assert utils.type_intersection(s1, s5) is "separate"
    assert utils.type_intersection(s1, r5) is "separate"
    assert utils.type_intersection(r1, r5) is "separate"
    assert utils.type_intersection(c1, c2) is "invalid"
    assert utils.type_intersection(c2, c3) is "invalid"
    assert utils.type_intersection(c2, c6) is "invalid"
    assert utils.type_intersection(c1, c5) is "intersect"
    assert utils.type_intersection(c1, c6) is "separate"
    assert utils.type_intersection(c6, c7) is "separate"
    assert utils.type_intersection(s1, c2) is "invalid"
    assert utils.type_intersection(c3, r1) is "invalid"
    assert utils.type_intersection(c5, r4) is "invalid"
    assert utils.type_intersection(s1, c4) is "invalid"
    assert utils.type_intersection(c1, r4) is "invalid"
    assert utils.type_intersection(s1, c5) is "intersect"
    assert utils.type_intersection(c5, r5) is "intersect"
    assert utils.type_intersection(c1, r1) is "intersect"
    assert utils.type_intersection(s1, c1) is "intersect"
    assert utils.type_intersection(r1, c5) is "intersect"
    assert utils.type_intersection(s1, c7) is "separate"
    assert utils.type_intersection(c1, s5) is "separate"
    assert utils.type_intersection(c6, r6) is "separate"
    assert utils.type_intersection(c6, s1) is "separate"
    assert utils.type_intersection(s1, c7) is "separate"
